...
class EmailAddressValidator
{
    ...
    public const RFC_5321 = 5321;
    // The RFC 5322 constant
    public const RFC_5322 = 5322;
    /**
     * The email address
     *
     * @access private
    ...
    public function __construct($email_address, $standard = null)
    {
        ...
        switch ($standard) {
            ...
            default:
                throw new InvalidArgumentException('Unknown RFC standard for email address validation.');
        }
    }
     ...
     * @return string
     */
    private function _getFWS($define = false): ?string
    {
     ...
     * @return string
     */
    private function _getCFWS($define = false): ?string
    {
